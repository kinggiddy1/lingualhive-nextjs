...
export const translations: Record<Lang, Dict> = {
  ...
  rw: {
    ...
    "services.title": "Huduma kamili za lugha",
    "services.subtitle": "Mfumo kamili wa suluhisho za lugha uliobuniwa kwa ajili ya mashirika makubwa zaidi barani Afrika.",
    "services.translation.title": "Tafsiri",
    "services.translation.desc": "Tafsiri sahihi na inayozingatia utamaduni katika lugha zaidi ya 50 za Afrika na duniani kote.",
    "services.interpretation.title": "Ukalimani",
    "services.interpretation.desc": "Ukalimani wa wakati mmoja, mfululizo na wa makongamano kwa matukio ya kila ukubwa.",
    "services.localization.title": "Ubinafsishaji",
    "services.localization.desc": "Kubadilisha tovuti, programu, video na maudhui ya kujifunza kwa masoko ya ndani ya Afrika.",
    "services.transcription.title": "Unukuzi na Manukuu",
    "services.transcription.desc": "Unukuzi kamili, maandishi ya sauti na manukuu ya lugha nyingi kwa vyombo vya habari na utafiti.",
    "services.consultancy.title": "Ushauri wa Lugha",
    "services.consultancy.desc": "Ushauri wa kimkakati wa lugha, usimamizi wa istilahi na ukaguzi wa lugha.",
    "services.training.title": "Mafunzo ya Lugha",
    "services.training.desc": "Mafunzo ya lugha ya shirika katika Kinyarwanda, Kiingereza, Kifaransa na Kiswahili.",
