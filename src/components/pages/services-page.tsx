  ...
  const services = [
    {
      ...
      features: ["Document translation", "Certified translation", "Technical & legal", "50+ languages"],
    },
    {
      ...
      features: ["Simultaneous interpretation", "Consecutive interpretation", "Conference interpretation", "Equipment rental"],
    },
    {
      ...
      features: ["Website localization", "App & software", "E-learning content", "Multimedia"],
    },
    {
      ...
      features: ["Verbatim transcription", "Closed captioning", "Multilingual subtitling", "Voice-over"],
    },
    {
      ...
      features: ["Linguistic strategy", "Terminology management", "Style guides", "Language audits"],
    },
    {
      ...
      features: ["Corporate coaching", "Group classes", "1-on-1 sessions", "Certification prep"],
    },
  ];
